...
import {TReentrancyGuard} from "../libs/TReentrancyGuard.sol";
...
contract DutchAuction is OwnableRoles, TReentrancyGuard {
    ...
    /// @dev The address of the fund contract (tokens to be sold)
    address public immutable fund;

    /// @dev The address of the payment token (tokens used as payment)
    address public immutable paymentToken;

    /// @dev The decimals of the fund token
    ...
    /// @param _fund The address of the fund contract (tokens to be sold)
    /// @param _owner The address of the owner of the contract
    /// @param _paymentToken The address of the payment token (tokens used as payment)
    constructor(address _fund, address _owner, address _paymentToken) {
        fund = _fund;
        paymentToken = _paymentToken;
        _initializeOwner(_owner);
        decimals = IFund(_fund).decimals();
    }
